...
export const ProgrammingMainContent = ({ sectionClassName }: { sectionClassName?: string }) => {
	return (
		<>
			<section
				id="programming"
				className={`font-geist-sans mt-32 block w-full px-4 py-6 lg:mt-0 lg:py-0 ${sectionClassName}`}
			>
				<div className="space-y-6">
					...
					<p className="text-zinc-400">Um pouco sobre minha trajetória até conhecer a programação.</p>
				</div>
				<Separator className="mt-6 mb-6 w-full bg-zinc-700" />
			...
			<section id="career" className="font-geist-sans custom-scrollbar block w-full px-4">
				<div className="space-y-6">
					<div className="group flex items-center gap-2">
				...
				<Separator className="mt-6 mb-6 w-full bg-zinc-700" />
				<div className="mb-6 space-y-6">
					<h3 className="text-2xl font-semibold text-white">Entrada na MyByte</h3>
					<p className="text-background">
