  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        <p className="font-geist-sans text-muted-foreground text-xs">Escolha um projeto</p>
        <button
          aria-label="Fechar"
          onClick={onClose}
      ...
      <SectionList items={PROJECTS_SECTIONS} makeNavigate={makeNavigate} currentHash={currentHash} title="Navegue pelos projetos" />
    </motion.div>
  );
};
