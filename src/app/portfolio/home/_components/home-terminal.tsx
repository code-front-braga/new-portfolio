...
export const HomeTerminal = () => {
	return (
		<motion.div
			className="relative hidden w-full max-w-4xl justify-center lg:flex"
			initial={{ opacity: 0, x: 24 }}
			animate={{ opacity: 1, x: 0 }}
			transition={{ type: 'spring', stiffness: 240, damping: 26, delay: 0.1 }}
		>
			<Terminal className="w-full max-w-4xl rounded-lg text-xs lg:text-sm">
				...
				<AnimatedSpan className="text-wrap text-white">
					<span>{'{'}</span>
					<span className="lg:block lg:pl-4">
						&quot;frontend&quot;: <br /> {'  '}[<br />
						{'    '}&quot;Next.js&quot;, &quot;React&quot;, &quot;TypeScript&quot;, &quot;Tailwind CSS&quot;,
						&quot;Zod&quot;, &quot;shadcn/ui&quot;, &quot;react-hook-form&quot;
						<br />
						{'   '}],
					</span>
					<span className="lg:block lg:pl-4">
						&quot;backend&quot;: <br /> {'  '}[<br />
						{'    '}&quot;Node.js&quot;, &quot;Prisma ORM&quot;, &quot;PostgreSQL&quot;, &quot;Better-auth&quot;,
						&quot;AuthJS&quot;
						<br />
						{'   '}],
					</span>
					<span className="lg:block lg:pl-4">
						&quot;tools&quot;: <br />
						{'   '}[<br />
						{'    '}&quot;Git&quot;, &quot;Postman&quot;, &quot;VSCode IDE&quot;, &quot;TRAE IDE&quot;,
